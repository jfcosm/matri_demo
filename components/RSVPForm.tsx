  ...
  if (submitted) {
    return (
      <div className="text-center py-12 bg-white rounded-[40px] shadow-sm border border-gray-100 px-8 animate-in zoom-in duration-500 max-w-xl mx-auto">
        ...
        <h3 className="font-serif italic text-3xl mb-4 text-gray-800">{t('rsvp.successTitle')}</h3>
  ...
  return (
    <section id="rsvp" className="space-y-10 py-10 max-w-xl mx-auto">
      <div className="text-center space-y-3">
        <h3 className="font-serif italic text-4xl text-gray-800">{t('rsvp.title')}</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-white p-8 md:p-12 rounded-[40px] shadow-xl border border-gray-50">
        <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-12 py-2">
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <span className={`text-sm font-medium transition-colors ${formData.attendance === 'yes' ? 'text-gray-800' : 'text-gray-400'}`}>{t('rsvp.yes')}</span>
          </label>
          <label className="flex items-center gap-3 cursor-pointer group">
            <div className="relative flex items-center justify-center">
              <input
            ...
            <span className={`text-sm font-medium transition-colors ${formData.attendance === 'no' ? 'text-gray-800' : 'text-gray-400'}`}>{t('rsvp.no')}</span>
          </label>
        </div>
