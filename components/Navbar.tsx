        ...
        <nav className="fixed top-0 left-0 right-0 z-50 p-4 animate-in fade-in slide-in-from-top-4 duration-700 pointer-events-none">
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center bg-white/70 backdrop-blur-md shadow-sm border border-white/50 rounded-2xl px-6 py-3 gap-4 pointer-events-auto">
                <div className="flex items-center gap-2 w-full md:w-auto">
                    <label htmlFor="template-select" className="text-xs font-semibold text-[var(--color-text)] opacity-60 uppercase tracking-widest min-w-max">
                    ...
                    <select
                        ...
                        className="bg-transparent text-sm text-[var(--color-text)] opacity-90 font-medium focus:outline-none cursor-pointer w-full md:w-auto appearance-none pr-4"
                    >
                ...
                <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                    <label htmlFor="language-select" className="text-xs font-semibold text-[var(--color-text)] opacity-60 uppercase tracking-widest min-w-max">
                    ...
                    <select
                        ...
                        className="bg-transparent text-sm text-[var(--color-text)] opacity-90 font-medium focus:outline-none cursor-pointer appearance-none"
                    >
                        {LANGUAGES.map((lang) => (
