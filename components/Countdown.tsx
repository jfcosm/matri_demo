  ...
  return (
    <div className="flex flex-col items-center w-full max-w-sm mx-auto">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-white border border-[var(--color-primary)]/30 px-8 py-3 rounded-full text-[10px] text-[var(--color-primary)] font-bold uppercase tracking-widest shadow-sm hover:shadow-md hover:bg-[var(--color-primary)] hover:text-white transition-all active:scale-95"
      >
