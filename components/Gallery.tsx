  ...
  return (
    <div className="w-full py-16 px-6 bg-[var(--color-bg)] rounded-[40px] border border-dashed border-[var(--color-primary)]/30 flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in zoom-in duration-700">
      ...
      <div className="max-w-md space-y-4">
        <p className="text-[11px] md:text-xs text-[var(--color-primary)] uppercase tracking-[0.3em] font-bold">
          Feed de Instagram
        </p>
        <p className="text-sm md:text-base text-[var(--color-text)] opacity-60 leading-relaxed font-medium">
        ...
        <div className="pt-4">
          <a
            href={INSTAGRAM_DETAILS.url}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-white border border-[var(--color-text)] border-opacity-10 px-6 py-2 rounded-full shadow-sm text-[10px] uppercase tracking-widest font-bold text-[var(--color-text)] opacity-50 hover:text-[var(--color-primary)] transition-all"
          >
